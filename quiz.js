...
function scoreRender(){
    ...
    scoreDiv.innerHTML += "<p><Span>Your Score:<span>"+ scorePerCent +"%</p>";
	
	document.getElementById('timer').innerHTML = "<a href='javascript:void(0)' class='button' onclick='window.location.reload()'>Try Again</a>";
